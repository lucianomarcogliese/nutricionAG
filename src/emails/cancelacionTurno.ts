...
export const cancelacionTurnoSubject = "Tu turno fue cancelado"

export function cancelacionTurnoHtml({ nombre, fecha, hora, nutricionista, baseUrl }: Props): string {
      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background:#ffffff;border-radius:16px;overflow:hidden;border:1px solid #e5e7eb">
        ...
        <tr>
          <td style="padding:40px">
            ...
            <p style="margin:0 0 28px;color:#374151;font-size:15px;line-height:1.6">Tu turno fue cancelado. Aquí están los detalles del turno cancelado:</p>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="background:#fef3c7;border:1px solid #fde68a;border-radius:10px;margin-bottom:28px">
              <tr>
                <td style="padding:16px 20px">
                  <p style="margin:0;color:#92400e;font-size:14px;line-height:1.5">Si querés volver a agendarte, podés hacerlo desde tu panel de turnos.</p>
                </td>
              </tr>
            </table>
